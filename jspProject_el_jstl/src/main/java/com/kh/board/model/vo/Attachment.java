...
public class Attachment {
	...
	public Attachment(int fileNo, int refBoardNo, String originName, String changeName, String filePath,
			Date uploadDate, int fileLebel, String status) {
		super();
		this.fileNo = fileNo;
	...
	public int getFileLebel() {
		return fileLebel;
	}


	public void setFileLebel(int fileLebel) {
		this.fileLebel = fileLebel;
	}
	...
	public String toString() {
		return "Attachment [fileNo=" + fileNo + ", refBoardNo=" + refBoardNo + ", originName=" + originName
				...
				+ ", fileLebel=" + fileLebel + ", status=" + status + "]";
	}
